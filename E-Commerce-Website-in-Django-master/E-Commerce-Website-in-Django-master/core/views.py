...
def payment(request):
    print("Payment Handling View: Order details saved")
    try:
        order = Order.objects.get(user=request.user, ordered=False)
...
def render_pdf_view(request):
    print("Payment Handling View: render_pdf_view")
...
def handlerequest(request):
    print("Payment Handling View: handlerequest")
    if request.method == "POST":
        try:
...
def invoice(request):
    print("Payment Handling View: invoice")
