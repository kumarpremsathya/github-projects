...
from functions import pdf_download_convert_to_excel, log, get_data_count_database, check_increment_data

def main():
    if pop_config.source_status == "Active":
        pdf_download_convert_to_excel.navigate_to_the_page()
        # check_increment_data.check_increment_data(r"C:\Users\mohan.7482\Desktop\PFRDA\List of entities registered as POP with PFRDA\data\first_excel_sheet\first_excel_sheet2024-04-23.xlsx")
        print("finished")
